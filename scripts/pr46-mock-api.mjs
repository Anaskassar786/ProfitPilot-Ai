...
const agents = ['REVENUE_AGENT', 'INVENTORY_AGENT', 'CUSTOMER_AGENT', 'PRICING_AGENT', 'CAMPAIGN_AGENT', 'PRODUCT_AGENT', 'EXECUTIVE_AGENT'].map((id, i) => ({ id, label: id.replaceAll('_', ' '), promptVersion: '1.0.0', enabled: true, execution: 'READY', languageOnly: true }))
