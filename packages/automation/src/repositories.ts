...
export class PostgresWorkflowRepository implements WorkflowRepository {
  ...
  public async put(definition: WorkflowDefinition): Promise<void> { await this.executor.query(`INSERT INTO workflows (id, store_id, version, definition_hash, definition, status) VALUES ($1, $2, $3, NULL, $4::jsonb, 'DRAFT') ON CONFLICT (store_id, id, version) DO UPDATE SET definition = EXCLUDED.definition`, [definition.id, definition.storeId, definition.version, JSON.stringify(definition)]) }
