...
export const PLAN_DEFINITIONS: Readonly<Record<PlanCode, PlanDefinition>> = {
  START: { code: 'START', tier: 'start', monthlyPrice: 49, annualPrice: 490, annualMonthsFree: 2, headline: 'Basic analytics for one store', storeLimit: 1, agents: START_AGENTS, features: ['Basic analytics for 1 store', '3 AI agents: Revenue, Inventory, Customer', '100 AI Command / day', 'Email support', '200 Jarvis messages / month', '5 automation workflows', 'Closed-period reports'], limits: PLAN_ENTITLEMENT_LIMITS.start },
  GROWTH: { code: 'GROWTH', tier: 'growth', monthlyPrice: 149, annualPrice: 1_490, annualMonthsFree: 2, recommended: true, headline: 'AI agents and advanced analytics', storeLimit: 3, agents: GROWTH_AGENTS, features: ['Advanced analytics for up to 3 stores', '5 AI agents: adds Pricing and Campaign', '300 AI Command / day', '700 Jarvis messages / month', '20 automation workflows and 15 campaigns', 'Forecasting and attribution'], limits: PLAN_ENTITLEMENT_LIMITS.growth },
  COMMANDER: { code: 'COMMANDER', tier: 'commander', monthlyPrice: 349, annualPrice: 3_490, annualMonthsFree: 2, headline: 'Full AI employee, unlimited stores', storeLimit: null, agents: COMMANDER_AGENTS, features: ['Full AI employee: all 7 agents', 'Unlimited AI Command + store actions', 'Unlimited Jarvis, automations, and campaigns', 'Priority support', 'Advanced forecasting and attribution', 'Highest daily AI budget'], limits: PLAN_ENTITLEMENT_LIMITS.commander },
}
