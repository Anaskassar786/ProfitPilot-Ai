...
export const PLAN_DEFINITIONS: Readonly<Record<PlanCode, PlanDefinition>> = {
  ...
  GROWTH: {
    ...
    features: [
      ...
      'Advanced Forecasting & ROI tracking',
  ...
  COMMANDER: {
    ...
    annualPrice: 3_490,
    annualMonthsFree: 2,
    headline: 'Full AI employee for unlimited stores',
    storeLimit: null,
    agents: COMMANDER_AGENTS,
    features: [
      'Full AI employee for unlimited stores',
      'All 6 AI agents (Product & Executive unlocked)',
      'Unlimited AI Commands & Automations',
      'Auto-execution (AI takes action for you)',
      'VIP 4-hour Support',
    ],
