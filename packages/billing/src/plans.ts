...
export const PLAN_DEFINITIONS: Readonly<Record<PlanCode, PlanDefinition>> = {
  ...
  GROWTH: { code: 'GROWTH', tier: 'growth', monthlyPrice: 149, annualPrice: 1_490, annualMonthsFree: 2, recommended: true, headline: 'AI agents and advanced analytics', storeLimit: 3, agents: GROWTH_AGENTS, features: ['Advanced analytics for up to 3 stores', '5 AI agents: adds Pricing and Campaign', '700 Jarvis messages / month', '20 automation workflows and 15 campaigns', 'Forecasting and attribution'], limits: PLAN_ENTITLEMENT_LIMITS.growth },
