...
export const PLAN_DEFINITIONS: Readonly<Record<PlanCode, PlanDefinition>> = {
  START: { code: 'START', tier: 'start', monthlyPrice: 49, annualPrice: 490, annualMonthsFree: 2, headline: 'Basic analytics for one store', storeLimit: 1, features: ['Basic analytics for 1 store', 'Email support', '200 Jarvis messages / month', '5 automation workflows', 'Closed-period reports'], limits: { orders_sync_month: 500, products_sync: 1_000, customers_sync: 2_000, ai_recommendations_month: 30, active_agents: 3, jarvis_messages_month: 200, automation_workflows: 5, active_campaigns: 3, email_sends_month: 1_000, sms_sends_month: 0, team_members: 1, reports: 1, exports: 1, forecasting: 1, attribution: 1 } },
  GROWTH: { code: 'GROWTH', tier: 'growth', monthlyPrice: 149, annualPrice: 1_490, annualMonthsFree: 2, recommended: true, headline: 'AI agents and advanced analytics', storeLimit: 3, features: ['Advanced analytics for up to 3 stores', 'AI agents and recommendations', '700 Jarvis messages / month', '20 automation workflows and 15 campaigns', 'Forecasting and attribution'], limits: { orders_sync_month: 5_000, products_sync: 10_000, customers_sync: 20_000, ai_recommendations_month: 150, active_agents: 6, jarvis_messages_month: 700, automation_workflows: 20, active_campaigns: 15, email_sends_month: 15_000, sms_sends_month: 2_000, team_members: 3, reports: 2, exports: 2, forecasting: 2, attribution: 2 } },
