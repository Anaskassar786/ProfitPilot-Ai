...
export const PLAN_ENTITLEMENT_LIMITS: Readonly<Record<PlanTier, Readonly<Record<EntitlementKey, number | null>>>> = {
  ...
  growth: { orders_sync_month: 5_000, products_sync: 10_000, customers_sync: 20_000, ai_recommendations_month: 150, active_agents: 4, jarvis_messages_month: 700, automation_workflows: 20, active_campaigns: 15, email_sends_month: 15_000, sms_sends_month: 2_000, team_members: 3, reports: 2, exports: 2, forecasting: 2, attribution: 2, ai_command_daily: 300, ai_executive_reports_month: 5, ai_executive_scenarios_month: 5, ai_executive_health_month: 4, ai_executive_risk_scans_month: 4, ai_executive_pdf_month: 0, ai_executive_exports_month: 5, ai_executive_opportunities: 10, ai_executive_decisions: null, ai_executive_roadmaps_active: 3, ai_executive_benchmark_metrics: 10 },
