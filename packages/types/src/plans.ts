...
export const PLAN_ENTITLEMENT_LIMITS: Readonly<Record<PlanTier, Readonly<Record<EntitlementKey, number | null>>>> = {
  trial: { orders_sync_month: 100, products_sync: 100, customers_sync: 100, ai_recommendations_month: 10, active_agents: 2, jarvis_messages_month: 60, automation_workflows: 2, active_campaigns: 1, email_sends_month: 100, sms_sends_month: 0, team_members: 1, reports: 1, exports: 0, forecasting: 0, attribution: 0 },
  start: { orders_sync_month: 500, products_sync: 1_000, customers_sync: 2_000, ai_recommendations_month: 30, active_agents: 3, jarvis_messages_month: 200, automation_workflows: 5, active_campaigns: 3, email_sends_month: 1_000, sms_sends_month: 0, team_members: 1, reports: 1, exports: 1, forecasting: 1, attribution: 1 },
  growth: { orders_sync_month: 5_000, products_sync: 10_000, customers_sync: 20_000, ai_recommendations_month: 150, active_agents: 5, jarvis_messages_month: 700, automation_workflows: 20, active_campaigns: 15, email_sends_month: 15_000, sms_sends_month: 2_000, team_members: 3, reports: 2, exports: 2, forecasting: 2, attribution: 2 },
