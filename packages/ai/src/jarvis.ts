...
import { JarvisActionRegistry, describeActionsForPrompt, getJarvisStoreAction, parseActionInvocation, planAtLeast, planDisplayName } from './jarvis-actions.js'
...
function getActionPlan(invocation: JarvisActionInvocation, plan: JarvisPlan): JarvisActionPlan | null {
  ...
  if (!planAtLeast(plan, definition.minimumPlan)) return null
