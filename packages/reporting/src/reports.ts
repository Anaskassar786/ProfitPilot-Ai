...
import type { ExportFile, ExportRow } from './exporters.js'
...
export function generatePdfReport(filename = 'profitpilot-report.pdf', rows: readonly ExportRow[] = []): ExportFile {
  return writePdf(filename, rows)
}
