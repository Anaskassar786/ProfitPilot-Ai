...
The Vite proxy keeps browser calls relative while forwarding F2/F4 requests to the API during local development. Pass `?storeId=<tenant-id>&shop=<shop>.myshopify.com` to the web URL to load a real tenant context.
