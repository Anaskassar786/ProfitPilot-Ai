...
| Settings | `/ai-growth-command/patternai/settings` | Auto-discovery, frequency, categories, notifications, trend monitoring, persona refresh, and insight language preferences. |
