...
const ENV_ALIASES: Readonly<Record<string, readonly string[]>> = { OPENROUTER_API_KEY_1: ['OPENROUTER_API_KEY_1', 'OPENROUTER_API_KEY'], STORE_COACH_API_KEY: ['STORE_COACH_API_KEY', 'STORE_COACH_OPENROUTER_API_KEY', 'OPENROUTER_API_KEY', 'OPENROUTER_API_KEY_1', 'AI_COMMAND_API_KEY', 'INSIGHTS_HUB_API_KEY'], R2_ENDPOINT: ['R2_ENDPOINT', 'CLOUDFLARE_R2_ENDPOINT'], R2_BUCKET: ['R2_BUCKET', 'CLOUDFLARE_R2_BUCKET', 'CLOUDFLARE_R2_BUCKET_NAME'], R2_ACCESS_KEY_ID: ['R2_ACCESS_KEY_ID', 'CLOUDFLARE_R2_ACCESS_KEY_ID'], R2_SECRET_ACCESS_KEY: ['R2_SECRET_ACCESS_KEY', 'CLOUDFLARE_R2_SECRET_ACCESS_KEY'] }
