...
const recommendations = [{ id: 'r1', storeId: 'store-1' as never, agent: 'CUSTOMER_AGENT' as const, ruleId: 'CHURN_RISK' as const, title: 'Win back', reason: 'inactive', impactValue: 189, impactLabel: 'LTV', currency: 'USD', confidence: .92, confidenceLevel: 'HIGH' as const, actionType: 'SEND_EMAIL' as const, actionRisk: 'APPROVAL_REQUIRED' as const, status: 'PENDING' as const, evidencePack: {}, explanation: null, explanationStatus: 'AI_UNAVAILABLE' as const, model: null, version: 0, createdAt: '2024-05-14T00:00:00.000Z', entityKey: null, expiresAt: null, decidedAt: null, decidedBy: null, rejectReason: null, snoozedUntil: null }]
